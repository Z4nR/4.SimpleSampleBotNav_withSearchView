package com.zulham.gitroom.utils.provider
...
import com.zulham.gitroom.database.db.DatabaseContract.AUTHOR
...
class Provider: ContentProvider() {
    ...
    override fun query(
        ...
        return when {
            sUriMatcher.match(uri) == Git -> favHelper.queryAll()
            sUriMatcher.match(uri) == Git_ID -> favHelper.queryById(uri.lastPathSegment.toString())
            else -> null
        }
    }
